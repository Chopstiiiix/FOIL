...
- generic [ref=e3]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e16]:
      - textbox "How can FOIL help you today?" [active] [ref=e17]: Create a test project
      - button [ref=e18] [cursor=pointer]
      - generic [ref=e21]:
        - button "Enhance prompt" [ref=e23] [cursor=pointer]
        - generic [ref=e25]: Use Shift + Return for a new line
```