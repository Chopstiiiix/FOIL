  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-foil-elements-item-contentDefault hover:text-foil-elements-item-contentActive hover:bg-foil-elements-item-backgroundActive':
          !selected,
        'bg-foil-elements-item-backgroundAccent text-foil-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-foil-elements-item-backgroundActive text-foil-elements-item-contentDefault': !selected,
        'bg-foil-elements-item-backgroundAccent text-foil-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-foil-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
